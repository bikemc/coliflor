 ...
 //   public Book(double price, String description, boolean onRent, List<Review> reviews, int id, String bookTitle, int pageNo, String author, int publicationYear, String address, String preview, int point) {
  //    public BookPublication(Product product, Date publicationDate, boolean currentlyAvailable, int id, int bookNumber) {
    ...
    public RentalData() {
        ...
        bookPublication.add( new BookPublication(mainPageBook.get(0), new Date(), mainPageBook.get(0).isOnRent(), 1, 1));
        bookPublication.add( new BookPublication(mainPageBook.get(1), new Date(), mainPageBook.get(1).isOnRent(), 2, 2));
        bookPublication.add( new BookPublication(mainPageBook.get(2), new Date(), mainPageBook.get(2).isOnRent(), 3, 3));
        bookPublication.add( new BookPublication(mainPageBook.get(3), new Date(), mainPageBook.get(3).isOnRent(), 4, 4));
        bookPublication.add( new BookPublication(mainPageBook.get(4), new Date(), mainPageBook.get(4).isOnRent(), 5, 5));
        bookPublication.add( new BookPublication(mainPageBook.get(5), new Date(), mainPageBook.get(5).isOnRent(), 6, 6));
