...
public class PlaceAccountSettingsController {
    ...
    public void save(ActionEvent event) throws Exception
    {
        ...
        if (!name.getText().toString().equals("")){
            ...
            nameText = RentalData.placeRental.currentUser.getName();
        }
        ...
        if (!password.getText().toString().equals("")){
            ...
            passwordText = RentalData.placeRental.currentUser.getPassword();
        }
        ...
        if (!birthday.getText().toString().equals("")){
            ...
            birthDayText = RentalData.placeRental.currentUser.getBirthday().toString();
        }
        ...
        if (!phone.getText().toString().equals("")){
            ...
            phoneText = RentalData.placeRental.currentUser.getPhoneNumber() + "";
        }

        RentalData.placeRental.changeAccountInformation(nameText,passwordText,new Date(5,6,4),Long.parseLong(phoneText));
